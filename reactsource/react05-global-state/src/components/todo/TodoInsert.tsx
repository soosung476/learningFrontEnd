...
import type { TodoUpsert } from "./todo";
...
const TodoInsert = ({ onInsert }: { onInsert: (todo: TodoUpsert) => void }) => {
  ...
  return (
    <form
      className="flex items-center gap-2 rounded-2xl border border-line bg-subtle p-2 transition-shadow focus-within:ring-2 focus-within:ring-primary"
